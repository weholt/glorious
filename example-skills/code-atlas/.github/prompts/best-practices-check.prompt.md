...
- All findings should be created as issues using `uv run issues create`, with type set to "enhancement" and priority "medium".
...
- Create issues using the command:

```bash
uv run issues create "Enhancement title" \
  --description "Detailed description of the enhancement, why this is important, how it can be implemented, and any other relevant information" \
  --priority medium \
...
Use the following checklist to quickly assess the quality of a Python project or to ensure you haven't missed anything in your own project. Create issues using `uv run issues create` for any items that need attention.
