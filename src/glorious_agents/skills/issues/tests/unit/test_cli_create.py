...
class TestIssuesCreate:
    ...
    def test_create_with_type(self, cli_runner: CliRunner):
        ...
        result = cli_runner.invoke(app, ["create", "Fix bug", "--type", "bug", "--json"])
    ...
    def test_create_with_priority(self, cli_runner: CliRunner):
        ...
        result = cli_runner.invoke(app, ["create", "Critical task", "-p", "0", "--json"])
    ...
    def test_create_with_custom_id(self, cli_runner: CliRunner):
        ...
        result = cli_runner.invoke(app, ["create", "Task", "--id", "issue-custom123"])
    ...
    def test_create_json_output(self, cli_runner: CliRunner):
        ...
        result = cli_runner.invoke(app, ["create", "Test issue", "--json"])
...
"""
        ...
        result = cli_runner.invoke(app, ["create", "-f", str(issues_file), "--json"])
    ...
    def test_create_then_list(self, cli_runner: CliRunner):
        ...
        # Create an issue
        create_result = cli_runner.invoke(app, ["create", "Test issue", "--type", "task", "-p", "2", "--json"])
    ...
    def test_create_then_show(self, cli_runner: CliRunner):
        ...
        # Create an issue
        create_result = cli_runner.invoke(app, ["create", "Another test", "--json"])
        assert create_result.exit_code == 0
        created = json.loads(create_result.stdout)
        issue_id = created["id"]
    ...
    def test_create_then_update(self, cli_runner: CliRunner):
        ...
        # Create an issue
        create_result = cli_runner.invoke(app, ["create", "Original title", "-p", "3", "--json"])
        assert create_result.exit_code == 0
        created = json.loads(create_result.stdout)
        issue_id = created["id"]

        # Update the issue
        update_result = cli_runner.invoke(app, ["update", issue_id, "--title", "Updated title", "-p", "1", "--json"])
