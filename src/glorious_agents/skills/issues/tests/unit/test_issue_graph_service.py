...
class TestGraphServiceDependencyCRUD:
    ...
    def test_add_dependency_success(
        self, graph_service: IssueGraphService, mock_uow: Mock, sample_issues: dict[str, Issue]
    ) -> None:
    ...
    def test_add_dependency_from_issue_not_found(
        self, graph_service: IssueGraphService, mock_uow: Mock, sample_issues: dict[str, Issue]
    ) -> None:
    ...
    def test_add_dependency_to_issue_not_found(
        self, graph_service: IssueGraphService, mock_uow: Mock, sample_issues: dict[str, Issue]
    ) -> None:
    ...
    def test_add_dependency_creates_cycle(
        self, graph_service: IssueGraphService, mock_uow: Mock, sample_issues: dict[str, Issue]
    ) -> None:
...
class TestGraphServiceCycleDetection:
    ...
    def test_detect_cycles_found(
        ...
        mock_uow.graph.get_dependencies = Mock(
...
class TestGraphServiceReadyQueue:
    ...
    def test_get_ready_queue(
        ...
        mock_uow.graph.get_blockers = Mock(
            side_effect=lambda id: {
                "ISS-A": [],
    ...
    def test_get_ready_queue_empty(
        self, graph_service: IssueGraphService, mock_uow: Mock, sample_issues: dict[str, Issue]
    ) -> None:
...
class TestGraphServiceTreeBuilding:
    ...
    def test_build_dependency_tree_custom_depth(
        self, graph_service: IssueGraphService, mock_uow: Mock, sample_issues: dict[str, Issue]
    ) -> None:
    ...
    def test_build_dependency_tree_leaf_node(
        self, graph_service: IssueGraphService, mock_uow: Mock, sample_issues: dict[str, Issue]
    ) -> None:
    ...
    def test_build_dependency_tree_with_circular_ref(
        self, graph_service: IssueGraphService, mock_uow: Mock, sample_issues: dict[str, Issue]
    ) -> None:
    ...
    def test_build_dependency_tree_exceeds_depth(
        self, graph_service: IssueGraphService, mock_uow: Mock, sample_issues: dict[str, Issue]
    ) -> None:
    ...
    def test_build_dependency_tree_missing_child(
        self, graph_service: IssueGraphService, mock_uow: Mock, sample_issues: dict[str, Issue]
    ) -> None:
...
class TestGraphServiceAdvancedScenarios:
    ...
    def test_get_blockers_filters_by_status(
        self, graph_service: IssueGraphService, mock_uow: Mock, sample_issues: dict[str, Issue]
    ) -> None:
