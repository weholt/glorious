...
class TestLabelsAdd:
    ...
    def test_label_add_single(self, cli_runner: CliRunner):
        ...
        result = cli_runner.invoke(app, ["labels", "add", issue_id, "bug"])
    ...
    def test_label_add_multiple(self, cli_runner: CliRunner):
        ...
        result = cli_runner.invoke(app, ["labels", "add", issue_id, "bug,critical,security"])
...
class TestLabelsRemove:
    ...
    def test_label_remove_single(self, cli_runner: CliRunner):
        ...
        result = cli_runner.invoke(app, ["labels", "remove", issue_id, "bug"])
    ...
    def test_label_remove_json_output(self, cli_runner: CliRunner):
        ...
        result = cli_runner.invoke(app, ["labels", "remove", issue_id, "bug", "--json"])
...
class TestLabelsSet:
    ...
    def test_label_set_replace(self, cli_runner: CliRunner):
        ...
        result = cli_runner.invoke(app, ["labels", "set", issue_id, "bug,p1"])
    ...
    def test_label_set_clear(self, cli_runner: CliRunner):
        ...
        result = cli_runner.invoke(app, ["labels", "set", issue_id, ""])
    ...
    def test_label_set_json_output(self, cli_runner: CliRunner):
        ...
        result = cli_runner.invoke(app, ["labels", "set", issue_id, "bug", "--json"])
