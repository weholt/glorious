"""Dependency injection for automations skill.
...
def get_engine() -> Engine:
    """Get database engine for automations skill.
...
def get_automation_service(
    ...
    """Get automation service with dependencies.
    ...
    Returns:
        Configured AutomationService instance
    """
    if engine is None:
        engine = get_engine()
    ...
    return AutomationService(uow, event_bus)
