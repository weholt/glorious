"""Dependency injection for orchestrator skill.
...
def get_engine() -> Engine:
    """Get database engine for orchestrator skill.
...
def get_orchestrator_service(
    ...
    """Get orchestrator service with dependencies.
    ...
    return OrchestratorService(uow, event_bus)
