"""Dependency injection for linker skill.
...
def get_engine() -> Engine:
    """Get database engine for linker skill.
...
def get_linker_service(
    engine: Engine | None = None, event_bus: EventBus | None = None
) -> LinkerService:
    """Get linker service with dependencies.
    ...
    Returns:
        Configured LinkerService instance
    """
    if engine is None:
        engine = get_engine()
    ...
    return LinkerService(uow, event_bus)
