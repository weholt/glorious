"""Dependency injection for vacuum skill.
...
def get_engine() -> Engine:
    """Get database engine for vacuum skill.
...
def get_vacuum_service(
    engine: Engine | None = None, event_bus: EventBus | None = None
) -> VacuumService:
    """Get vacuum service with dependencies.
    ...
    Returns:
        Configured VacuumService instance
    """
    if engine is None:
        engine = get_engine()
    ...
    return VacuumService(uow, event_bus)
