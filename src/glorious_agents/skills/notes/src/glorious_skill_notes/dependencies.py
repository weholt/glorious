"""Dependency injection for notes skill.
...
def get_engine() -> Engine:
    """Get database engine for notes skill.
...
def get_notes_service(
    ...
    """Get notes service with dependencies.
    ...
    service = NotesService(uow, event_bus)

    # Ensure FTS tables and triggers exist
    service._ensure_fts_tables()
